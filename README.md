...
Om **Redis** te starten gebruik je het _commando sudo systemctl start redis_ (of gebruik **redis.sh** van de map Bash scripts).

Om **Redis** te stoppen gebruik je het _commando sudo systemctl stop_ redis (of gebruik **redis.sh** van de map Bash scripts).
