...
Om de scripts **red.py** en **redToMongo.py** te kunnen runnen gebruik je de commando's python3 red.py en python3 redToMongo.py. Om de uitvoering van de scripts te stoppen, typ je ctrl + c in de terminal.
