...
Ik heb mijn script op mijn Windows pc gemaakt. Download deze repository op Ubuntu via de commando git clone <code> https://github.com/KatoBeke/Databases-advanced.git </code>. <br> 
